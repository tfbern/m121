...
Der Quellcode befindet sich im Anhang [10.1](#Arduino%20Sketch).
...
Der Quellcode befindet sich im Anhang [10.2](#Serial%20Gateway).
...
Der Quellcode befindet sich im Anhang [10.3](#WebSocket%20Server).
...
Der Quellcode befindet sich im Anhang [10.4](#Web%20Client).
...
Dieses Dokument wurde mit LaTeX erstellt. Der Quellcode befindet sich in
der Datei `_doc/paper.tex`. Die Quellensammlung befindet sich in der
Datei `_doc/quellen.tex` klk

## LaTeX Umgebung

Dazu wurde TeX Live \[24\] installiert. Dieses Paket stellt zahlreiche
Tools zur Verfügung, darunter `pdflatex`

## LaTeX Editor

Als Editor wurde Visual Studio Code \[7\] mit der Erweiterung LaTeX
Workshop \[25\] verwendet.

Das automatische Speichern kann in Visual Studio Code unter `File ->
Auto save` aktiviert werden. Mit `Ctrl+Alt+V` wird die Vorschau des
generierten PDFs aktiviert. Mit `Alt+Z` kann der automatische
Zeilenumbruch eingeschalten werden.

Vorteile gegenüber Microsoft Word sind die automatische
Vervollständigung beim Schreiben, sowie die einfache Einbindung von
Quellcode Listings wie in Anhang A.

Weitere Informationen zum Erstellen des Inhaltsverzeichnis und des
Literaturverzeichnis finden sich unter \[26\] und \[27\].
...
Diese Pakete sind im Lieferumfang von TeX Live dabei und müssen nicht
speziell installiert werden.
...
\[25\] <span class="smallcaps">Yu, James</span>: LaTeX Workshop.

</div>

<div id="ref-inhaltsverzeichnis">

\[26\] *LaTeX: Inhaltsverzeichnis anlegen - so geht’s*. URL
...
\[27\] *LaTeX: Literaturverzeichnis erstellen - so klappt’s*. URL
